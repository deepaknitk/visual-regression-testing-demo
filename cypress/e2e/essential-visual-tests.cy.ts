describe('Visual Regression Tests - Essential Screenshots', () => {
  ...
  it('6. Navigation - Active States', () => {
    ...
    cy.percySnapshot(`${envPrefix}-06-Navigation-Active`);
  });
  ...
  it('7. Dashboard - Charts Section', () => {
    ...
    cy.percySnapshot(`${envPrefix}-07-Dashboard-Charts`);
  });
  ...
  it('8. Users - Status Variations', () => {
    ...
    cy.percySnapshot(`${envPrefix}-08-Users-Status`);
  });
  ...
  it('9. Profile - Form Section', () => {
    ...
    cy.percySnapshot(`${envPrefix}-09-Profile-Form`);
  });
  ...
  it('10. Settings - Preferences', () => {
    ...
    cy.percySnapshot(`${envPrefix}-10-Settings-Preferences`);
  });
});
